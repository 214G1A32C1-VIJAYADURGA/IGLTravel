...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-WLEBLK2F.js";
import "./chunk-7ILADRH4.js";
import {
  require_react_dom
...
function useSize(element) {
  const [size2, setSize] = React15.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React16.useState(null);
...
function usePrevious(value) {
  const ref = React19.useRef({ value, previous: value });
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React24.useState(styleSingleton)[0];
  ...
  return React24.createElement(
    React24.Fragment,
    null,
    inert ? React24.createElement(Style, { styles: generateStyle(id) }) : null,
